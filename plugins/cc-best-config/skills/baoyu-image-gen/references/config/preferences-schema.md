...
default_provider: null      # google|openai|openrouter|dashscope|modelscope|replicate|null (null = auto-detect)
...
default_model:
  ...
  modelscope: null          # e.g., "Qwen/Qwen-Image-2512"
...
| `default_model.modelscope` | string\|null | null | ModelScope default model |
